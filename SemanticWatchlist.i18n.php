...
$messages['ru'] = array(
	...
	'swl-watchlist-position' => "{{PLURAL:$1|Показано последнее изменение|Показаны последние '''$1''' изменения, начиная с изменения '''#$2'''|Показаны последние '''$1''' изменений, начиная с изменения '''#$2'''}}:",
