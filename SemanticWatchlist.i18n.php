...
$messages['ru'] = array(
	...
	'swl-watchlist-position' => "{{PLURAL:$1|Показано последнее изменение|Показаны последние '''$1''' изменений, начиная с изменения '''#$2'''|Показаны последние '''$1''' изменения, начиная с изменения '''#$2'''}}:", # Fuzzy
	...
	'swl-watchlist-firstn-title' => '{{PLURAL:$1|1=|Первые}} $1 {{PLURAL:$1|результат|результатов|результата}}', # Fuzzy
	...
	'swl-prefs-category-label' => "'''$1''': {{PLURAL:$2|свойство|свойств|свойства}} $3 из категории ''$4''", # Fuzzy
	'swl-prefs-namespace-label' => "'''$1''': {{PLURAL:$2|свойство|свойств|свойства}} $3 из пространства имён ''$4''", # Fuzzy
	'swl-prefs-concept-label' => "'''$1''': {{PLURAL:$2|1=свойство|свойства}} $3 из концепта ''$4''", # Fuzzy
