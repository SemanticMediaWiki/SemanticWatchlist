...
$messages['fi'] = array(
	...
	'swl-custom-input' => 'Jos ominaisuuden $1 muutettu arvo on $2, ilmoita siitä käyttäjille huomautuksella: $3',
	'swl-watchlist-position' => "Näyttää '''$1''' {{PLURAL:$1|muutoksen|viimeisintä muutosta}}, joista ensimmäinen on '''#$2'''.",
	...
	'swl-watchlist-can-mod-prefs' => 'Voit [[$1|muokata tarkkailulistan asetuksia]] ja myös määrittää tarkkailtavat ominaisuudet.',
	...
	'swl-email-propschanged-long' => "'''$1''' -wikin tarkkailulistallasi on muutoksia, jotka on tehnyt '''$2''' $5 klo $4. Voit tarkastella näitä ja muita muutoksia [$3 semanttisella tarkkailulistallasi].",
...
$messages['lb'] = array(
	...
	'swl-group-page-selection' => 'fir Säiten a(n)',
 ...
 */
$messages['pms'] = array(
	'semanticwatchlist-desc' => "J'utent a son notificà ëd cambi specìfich ai dat ëd Semantic MediaWiki",
	'right-semanticwatch' => "Dòvra la lista semàntica ëd lòn ch'as ten sot euj",
	'right-semanticwatchgroups' => "[[Special:WatchlistConditions|Modìfica]] le partìe dla lista semantica ëd lòn ch'as ten sot euj",
	...
	'group-swladmins' => "Aministrador ël la lista semàntica ëd lòn ch'as ten sot euj",
	'group-swladmins-member' => "{{GENDER:$1|Aministrador ëd la Lista Semàntica ëd lòn ch'as ten sot euj}}",
	'grouppage-swladmins' => "{{ns:project}}:Aministrador ëd la Lista Semàntica ëd lòn ch'as ten sot euj",
	'swl-group-name' => 'Nòm ëd partìa:',
	'swl-group-legend' => 'Partìa',
	'swl-group-properties' => 'Sta partìa a ten sot euj ij cambi ant la/le propietà:',
	'swl-properties-list' => 'Separa ij nòm con |',
	'swl-group-page-selection' => 'Selession-a pagine da ten-e sot euj:',
	'swl-group-save' => 'Salva',
	...
	'swl-group-confirm-remove' => 'Ses-to sigur ëd vorèj gavé la partìa dla lista ël lòn ch\'as ten sot euj "$1"?',
	'swl-group-add-new-group' => 'Gionta na partìa neuva',
	'swl-group-add-group' => 'Gionté na partìa',
	'swl-custom-legend' => 'Test utent',
	'swl-custom-remove-property' => 'Gava',
	'swl-custom-text-add' => 'Gionta tent utent',
	'swl-custom-input' => "Se la propietà $1 a cangia ij sò valor a $2, notìfica j'utent con ël test ch'a ven: $3",
	'swl-watchlist-position' => "Mosté '''$1''' ëd l'ùltim {{PLURAL:$1|ccambi}} ancaminand con '''#$2'''.",
	...
	'swl-watchlist-no-items' => "A l'ha ancó pa gnun element dzora toa lista semàntica ëll lòn ch'as ten sot-euj.",
	'swl-watchlist-can-mod-groups' => "It peule [[$1|modifiché le partìe dla lista ëd lòn ch'as ten sot euj]].",
	'swl-watchlist-can-mod-prefs' => "It peule ëdcò [[$1|modifiché ij tò gust ëd la lista ëd lòn ch'as ten sot euj]], comprèis amposté che propietà tnì sot euj.",
	'swl-watchlist-no-groups' => "It të stas pa anco' tnisent sot euj minca partìa dla lista ëd lòn ch'as ten sot euj. [[$1|Modìfica ij tò gust dla lista ëd lòn ch'a ten sot euj]].",
	'swl-email-propschanged' => "Le propietà a l'han cangià a $1",
	'swl-email-propschanged-long' => "Un-a o pi propietà ch'it ten-e sot euj a '''$1''' a son stàite cangià da {{GENDER:$2|utent}} '''$2''' ai $4 dël $5. It peule vëdde cost e àutr cambi dzora [$3 toa lista semàntica ël lòn ch'as ten sot euj].",
	...
	'swl-prefs-emailnofity' => "Scrivme dzora cambi a propietà ch'im ten-o sot euj",
	'swl-prefs-watchlisttoplink' => "Mosta un colegament a la Lista Semàntica ëd lòn ch'as ten sot euj an testa dla pagina",
	...
	'swl-err-userid-xor-groupids' => 'O ël paràmetr userid o col groupid a deuv esse specificà, ma pa tùit doi.',
);
