...
$messages['pms'] = array(
	...
	'group-swladmins' => "Aministrator ëd la lista semàntica ëd lòn ch'as ten sot-euj",
	'group-swladmins-member' => "{{GENDER:$1|Aministrator ëd la Lista Semàntica ëd lòn ch'as ten sot-euj}}",
	'grouppage-swladmins' => "{{ns:project}}:Aministrator ëd la Lista Semàntica ëd lòn ch'as ten sot-euj",
	...
	'swl-custom-input' => "Se la propietà $1 a cangia ij sò valor a $2, notifiché j'utent con ël test sì-dapress: $3",
	'swl-watchlist-position' => "Mostré '''$1''' {{PLURAL:$1|dl'ùltima modìfica|dj'ùltime modìfiche}} an ancaminand con '''#$2'''.",
