...
$messages['de'] = array(
	...
	'swl-group-properties' => 'Attribute zu dieser Gruppe:', # Fuzzy
	'swl-group-remove-property' => 'Attribut entfernen',
	'swl-group-add-property' => 'Attribut hinzufügen',
	'swl-group-page-selection' => 'Seiten in', # Fuzzy
	...
	'swl-custom-remove-property' => 'Benutzerdefinierten Text entfernen', # Fuzzy
	'swl-custom-text-add' => 'Einen anderen benutzerdefinierten Text hinzufügen', # Fuzzy
	'swl-custom-input' => 'Benutzer mit dem folgenden Text benachrichtigen, falls das Attribut $1 seinen Wert auf $2 ändert: $3',
...
$messages['es'] = array(
	...
	'swl-group-properties' => 'Propiedades cubiertas por este grupo:', # Fuzzy
	'swl-group-remove-property' => 'Quitar propiedad',
	'swl-group-add-property' => 'Añadir propiedad',
	'swl-group-page-selection' => 'Páginas en', # Fuzzy
	...
	'swl-custom-remove-property' => 'Quitar texto personalizado', # Fuzzy
	'swl-custom-text-add' => 'Agregar otro texto personalizado', # Fuzzy
...
$messages['fr'] = array(
	...
	'swl-group-properties' => 'Propriétés de ce groupe :', # Fuzzy
	'swl-group-remove-property' => 'Retirez la propriété',
	'swl-group-add-property' => 'Ajouter une propriété',
	'swl-group-page-selection' => 'Pages dans la', # Fuzzy
	...
	'swl-custom-remove-property' => 'Texte de suppression personnalisé', # Fuzzy
	'swl-custom-text-add' => 'Ajouter un autre texte personnalisé', # Fuzzy
...
$messages['gl'] = array(
	...
	'swl-group-properties' => 'Propiedades cubertas por este grupo:', # Fuzzy
	'swl-group-remove-property' => 'Eliminar a propiedade',
	'swl-group-add-property' => 'Engadir a propiedade',
	'swl-group-page-selection' => 'Páxinas en', # Fuzzy
	...
	'swl-custom-remove-property' => 'Eliminar o texto personalizado', # Fuzzy
	'swl-custom-text-add' => 'Engadir outro texto personalizado', # Fuzzy
...
$messages['hsb'] = array(
	...
	'swl-group-properties' => 'Kajkosće tuteje skupiny:', # Fuzzy
	'swl-group-remove-property' => 'Kajkosć wotstronić',
	'swl-group-add-property' => 'Kajkosć přidać',
	'swl-group-page-selection' => 'Strony w', # Fuzzy
	...
	'swl-custom-remove-property' => 'Swójski tekst wotstronić', # Fuzzy
	'swl-custom-text-add' => 'Druhi swójski tekst přidać', # Fuzzy
...
$messages['ja'] = array(
	...
	'swl-group-properties' => 'このグループが対応するプロパティ:', # Fuzzy
	...
	'swl-custom-text-add' => '別のカスタム テキストを追加', # Fuzzy
...
$messages['mk'] = array(
	...
	'swl-group-properties' => 'Својства покриени со оваа група:', # Fuzzy
	'swl-group-remove-property' => 'Отстрани својство',
	'swl-group-add-property' => 'Додај својство',
	'swl-group-page-selection' => 'Страници во', # Fuzzy
	...
	'swl-custom-remove-property' => 'Отстрани прилагоден текст', # Fuzzy
	'swl-custom-text-add' => 'Стави друг прилагоден текст', # Fuzzy
