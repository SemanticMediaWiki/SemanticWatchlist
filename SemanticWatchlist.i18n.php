...
$messages['en'] = array(
	...
	'swl-custom-remove-property' => 'Remove Custom Text',
	'swl-custom-text-add' => 'Add another custom text',
...
$messages['de'] = array(
	...
	'swl-custom-remove-property' => 'Benutzerdefinierten Text entfernen',
	'swl-custom-text-add' => 'Einen anderen benutzerdefinierten Text hinzufügen',
...
$messages['es'] = array(
	...
	'swl-custom-remove-property' => 'Quitar texto personalizado',
	'swl-custom-text-add' => 'Agregar otro texto personalizado',
...
$messages['fr'] = array(
	...
	'swl-custom-remove-property' => 'Texte de suppression personnalisé',
	'swl-custom-text-add' => 'Ajouter un autre texte personnalisé',
...
$messages['gl'] = array(
	...
	'swl-custom-remove-property' => 'Eliminar o texto personalizado',
	'swl-custom-text-add' => 'Engadir outro texto personalizado',
...
$messages['hsb'] = array(
	...
	'swl-custom-remove-property' => 'Swójski tekst wotstronić',
	'swl-custom-text-add' => 'Druhi swójski tekst přidać',
...
$messages['ja'] = array(
	...
	'swl-group-confirmdelete' => 'ウォッチリストのグループ「$1」を本当に削除しますか?',
	'swl-group-save-all' => 'すべて保存',
	'swl-group-add-new-group' => '新規グループを追加',
	'swl-group-add-group' => 'グループを追加',
	'swl-custom-remove-property' => 'カスタム テキストを除去',
	'swl-custom-text-add' => '別のカスタム テキストを追加',
...
$messages['mk'] = array(
	...
	'swl-custom-remove-property' => 'Отстрани прилагоден текст',
	'swl-custom-text-add' => 'Стави друг прилагоден текст',
...
$messages['zh-hant'] = array(
	...
	'swl-group-concept' => '概念',
	'swl-group-confirmdelete' => '您確實要刪除"$1"監視列表組嗎？',
	'swl-group-save-all' => '全部保存',
